...
# Streamlit Documentation: https://docs.streamlit.io/get-started 
# run the program with streamlit run home.py
# reformatted expanders to be in two columns
...
#     # Left column: Innovation Hub and JOBSs
#     with left_col:
#         render_innovation_hub()
#         render_jobs()
    
#     # Right column: OCPD and STEM Centers
#     with right_col:
#         render_ocpd()
#         render_stem_centers()
...
# Streamlit Documentation: https://docs.streamlit.io/get-started 
# run the program with streamlit run home.py
# expanders are now containers; restructured placement of each resource's contact info
...
def main():
    ...
    # Create two columns for containers
    # left_col, right_col = st.columns(2)
