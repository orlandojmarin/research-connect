...
# Create a dummy 'auth' object for backward compatibility with existing imports
# This allows existing code that imports 'auth' to continue working
# Even though we don't use pyrebase's auth object anymore
class _AuthCompatibility:
    """Dummy class for backward compatibility - not actually used"""
    pass

auth = _AuthCompatibility()
